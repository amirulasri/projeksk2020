...
<?php
    if (isset($_GET['sudahdaftar'])) {
        ...
        echo 'alert("Anda sudah mendaftar sebagai pelanggan sekali. Anda tidak perlu mendaftar sekali lagi. Teruskan dengan tempahan homestay.")';
        echo '</script>';
    }
    if (isset($_GET['gagaltempahkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan anda gagal. Anda memasukkan Nombor Kad Pengenalan Yang salah. Sila cuba sekali lagi dengan nombor Kad Pengenalan yang betul")';
        echo '</script>';
    }
    if (isset($_GET['berjayatempah'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan telah berjaya. Untuk melihat tempahan yang telah anda lakukan, Anda boleh lihat di bahagian carian dan masukkan nombor kad pengenalan anda.")';
        echo '</script>';
    }
    if (isset($_GET['berjayadaftar'])) {
        echo '<script language="javascript">';
        echo 'alert("Anda telah berjaya mendaftar sebagai pelanggan. Teruskan dengan tempahan anda di tempah rumah.")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
