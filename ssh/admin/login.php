...
<body>
    ...
    if (isset($_GET['logkeluar'])) {
        ...
        echo 'alert("anda telah berjaya logkeluar harap bejumpa lagi")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])){
        echo '<script language="javascript">';
        echo 'alert("Nama pengguna atau kata laluan yang anda telah masukkan adalah salah sila cuba sekali lagi")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
