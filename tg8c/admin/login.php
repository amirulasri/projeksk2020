...
<body>
    ...
    if (isset($_GET['logkeluar'])) {
        ...
        echo 'alert("Log keluar telah berjaya,terima kasih menggunakan sistem kami.Jumpa lagi!")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])){
        echo '<script language="javascript">';
        echo 'alert("Nama pengguna atau kata laluan yang anda masukkan adalah tidak sah")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
