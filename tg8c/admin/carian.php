...
<body>
    ...
    if (isset($_GET['berjaya'])) {
        ...
        echo 'alert("Tempahan anda berjaya untuk dipupuskan")';
        echo '</script>';
    }
    if (isset($_GET['berjayakemaskini'])) {
        echo '<script language="javascript">';
        echo 'alert("Syabas!tempahan anda berjaya untuk dikemaskini")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan anda gagal untuk dipupuskan,sila cuba lagi")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
