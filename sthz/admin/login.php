...
<body>
    ...
    if (isset($_GET['logkeluar'])) {
        ...
        echo 'alert("Anda telah berjaya log keluar,terima kasih menggunakan sistem kami dan sila log masuk lagi yaa:(")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])){
        echo '<script language="javascript">';
        echo 'alert("Maaf,nama pengguna atau katalaluan anda salah.Sila masukkan nama pengguna atau katalaluan anda yang benar.")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
