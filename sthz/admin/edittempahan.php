...
<body>
    ...
    if (isset($_GET['berjaya'])) {
        ...
        echo 'alert("Tempahan anda dah berjaya dipadamkan ")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])) {
        echo '<script language="javascript">';
        echo 'alert("Maaf,tempahan anda x berjaya dipadamkan")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
            ...
            <div class="interface">
                <div class="mainmenu">
                    <form action="" method="post">
                        ...
                        <form action="" method="post">
                            <label for="">Pilih Permandangan:</label>
                            <select name="idrumah" id="" class="select" required>
                                <option value="">--->Pilih Permandangan<---</option> <?php
