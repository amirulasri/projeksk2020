...
<body>
    ...
    if (isset($_GET['gagal'])) {
        ...
        echo 'alert("Harap Maaf,nama pengguna atau kata laluan yang anda masukkan salah")';
        echo '</script>';
    }
    if (isset($_GET['logkeluar'])) {
        echo '<script language="javascript">';
        echo 'alert("Anda berjaya log keluar.Sila datang lagi")';
        echo '</script>';
    }
    if (isset($_GET['daftarberjaya'])) {
        echo '<script language="javascript">';
        echo 'alert("Anda berjaya daftar. Sila log masuk dengan menggunakan id dan katalaluan yang sudah didaftarkan")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
