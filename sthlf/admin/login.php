...
<body>
    ...
    if (isset($_GET['logkeluar'])) {
        ...
        echo 'alert("anda telah berjaya Log keluar terima kasih kerana sudi membuat tempahan di lily fancy")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])){
        echo '<script language="javascript">';
        echo 'alert("Nama pengguna atau kata laluan yang anda telah masukkan adalah salah")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
