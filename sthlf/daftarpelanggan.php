...
if(!empty($nokp)){
    header('location: index2.php?sudahdaftar=1');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    if (isset($_GET['perlu'])) {
        ...
        echo 'alert("jika anda ingin membuat tempahan sila masukkan butiran diri anda terlebih dahulu")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
        <div class="ui">
            ...
            if (isset($_POST['bilhari'])) {
                $jumlahtiket = $_POST['bilhari'];
            }
            if (isset($_POST['tarikhmasuk'])) {
                $tarikhtayangan = $_POST['tarikhmasuk'];
            }
            $querymovie = mysqli_query($conn, "SELECT * FROM rumah");
            ?>
            <div class="interface">
                <div class="mainmenu">
