...
<body>
<!-- pop up Anda telag gagal mendaftar sebagai pengguna baru  -->
    <?php
    if (isset($_GET['tidaktersedia'])) {
        echo '<script language="javascript">';
        echo 'alert("Maaf Nama pengguna yang anda masukkan tiada di dalam sistem.sila Gunakan nama pengguna yang lain")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
        <div class="ui">
            ...
            <div class="interfacelogin">
                <form action="prosesdaftar.php" method="post" name="form1">
                    <div class="mainmenu">
                    <!-- Anda telah mendaftar sebagai pengguna baru -->
    ...
    <script>
        function stringlength(inputtxt, minlength, maxlength) {
            ...
            if (field.length < mnlen) {
                ...
                return confirm('segala butiran Anda telah dilengkapkan. Klik OK untuk meneruskan pendaftaran, Klik Cancel untuk membatalkan pendaftaran');
            }
        }
    </script>
</body>
