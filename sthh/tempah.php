                ...
                <div class="mainmenu">
                    <form action="" method="post">
                        ...
                        <select name="idrumah" id="" class="select" required>
                            <option value="">--->Pilih Rumah<---</option> <?php
                                                                            while ($data = mysqli_fetch_array($queryrumah)) {
                                                                            ?> <option value="<?php echo $data['idrumah']; ?>" <?php if ($idrumah == $data['idrumah']) {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo $data['namarumah']; ?></option>
                        <?php } ?>
                        </select><br>
                    ...
                    <form action="prosestempah.php" method="post">
                        ...
                        if (isset($_POST['submit'])) {
                            $jumlahharga = 70 * $jumlahhari;
                            echo "<h3>Jumlah Harga: RM $jumlahharga</h3>
