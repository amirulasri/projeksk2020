...
<body>
    ...
    if (isset($_GET['gagal'])) {
        ...
        echo 'alert("Terdapat nama pengguna atau kata laluan yang salah")';
        echo '</script>';
    }
    if (isset($_GET['logkeluar'])) {
        echo '<script language="javascript">';
        echo 'alert("Sudah dilog keluarkan")';
        echo '</script>';
    }
    if (isset($_GET['daftarberjaya'])) {
        echo '<script language="javascript">';
        echo 'alert("Telah berjaya didaftarkan. Sila log masuk dengan menggunakan ID dan KATA LALUAN anda")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
