...
<?php
    if (isset($_GET['sudahdaftar'])) {
        ...
        echo 'alert("Anda sudah pun mendaftar sebagai pelanggan. Maaf Anda tidak boleh mendaftar sekali lagi. Teruskan dengan tempahan tiket wayang.")';
        echo '</script>';
    }
    if (isset($_GET['gagaltempahkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan gagal. Anda Telah memasukkan Nombor Kad Pengenalan Yang tidak selari atau anda sudah mendaftar dengan nombor kad pengenalan yang sama. Sila cuba lagi")';
        echo '</script>';
    }
    ...
    if (isset($_GET['gagaldaftarkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Pendaftaran Anda Gagal. KP pelanggan telah pun digunakan. Atau anda memasukkan NO KP yang salah.")';
        echo '</script>';
    }
    ?>
    <div class="header">
