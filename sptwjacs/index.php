...
<?php
    if (isset($_GET['sudahdaftar'])) {
        ...
        echo 'alert("Anda sudah pun mendaftar. Pendaftaran semula anda tidak diluluskan. Teruskan dengan tempahan tiket wayang.")';
        echo '</script>';
    }
    if (isset($_GET['gagaltempahkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan gagal. Nombor Kad Pengenalan adalah salah. Sila cuba sekali lagi")';
        echo '</script>';
    }
    if (isset($_GET['berjayatempah'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan berjaya!!!. Tempahan anda boleh di lihat pada bahagian carian dan masukkan nombor kad pengenalan anda.")';
        echo '</script>';
    }
    if (isset($_GET['gagaldaftarkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Maaf Pendaftaran Gagal. KP pelanggan telah digunakan. Atau anda memasukkan NO KP yang salah.")';
        echo '</script>';
    }
    if (isset($_GET['berjayadaftar'])) {
        echo '<script language="javascript">';
        echo 'alert("Anda sudah berjaya mendaftar sebagai pelanggan! Teruskan dengan pembelian tiket.")';
        echo '</script>';
    }
    ?>
    <div class="header">
        ...
        <div class="ui">
            ...
            <div class="interface">
                <div class="mainmenu">
                    ...
                    <p class="title" id="tukarwarna">Tempah tiket wayang mengikut pilihan anda.</p><br><br><br><br>
