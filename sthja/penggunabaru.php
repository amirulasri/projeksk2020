...
<body>
    ...
    if (isset($_GET['tidaktersedia'])) {
        ...
        echo 'alert("Maaf nama pengguna yang anda masukkan tidak tersedia. Gunakan nama pengguna yang lain")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
    ...
    <script>
        function stringlength(inputtxt, minlength, maxlength) {
            ...
            if (field.length < mnlen) {
                ...
                return confirm('Tahniah!  anda berjaya  memasukkan maklumat  dengan betul. Klik OK untuk meneruskan pendaftaran, Klik Cancel untuk membatalkan pendaftaran');
            }
        }
    </script>
</body>
