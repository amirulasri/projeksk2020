...
<body>
    ...
    if (isset($_GET['berjaya'])) {
        ...
        echo 'alert("Tempahan anda sudah dibatalkan")';
        echo '</script>';
    }
    if (isset($_GET['berjayakemaskini'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan anda sudah dikemaskini dengan jayanya")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])) {
        echo '<script language="javascript">';
        echo 'alert("Maaf Tempahan anda gagal dibatalkan, sila cuba lagi")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
