    ...
    <header>
        ...
        <nav class="hidenav">
            <ul>
                ...
                <li><a href="senarairumah.php" class="active">Senarai rumah</a></li>
    ...
    <div class="boranglogin">
        <div class="boranglogindalam">
            <div class="logininput">
                <h2 class="titlecolor">Export dan import data: <br> <u>Senarai Rumah</u></h2>
                <br><br>
                <form method="post" action="csveksportrumah.php">
                ...
                <form action="csvimportrumah.php" method="post" enctype="multipart/form-data">
                    <input type="file" accept=".csv" name="file" class="btn btn-warning" required />
