...
<body>
    ...
    if (isset($_GET['gagal'])) {
        ...
        echo 'alert("Nama pengguna atau kata laluan salah. Sila cuba sekali lagi")';
        echo '</script>';
    }
    ...
    if (isset($_GET['daftarberjaya'])) {
        echo '<script language="javascript">';
        echo 'alert("Anda Berjaya!. Sila log masuk dengan menggunakan ID dan KATA LALUAN anda")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
