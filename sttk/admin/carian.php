...
<body>
    ...
    if (isset($_GET['berjaya'])) {
        ...
        echo 'alert("untuk maklumat anda tempahan anda telah diperbaharui")';
        echo '</script>';
    }
    if (isset($_GET['berjayakemaskini'])) {
        echo '<script language="javascript">';
        echo 'alert("tahniah Tempahan anda telah berjaya dikemaskini")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])) {
        echo '<script language="javascript">';
        echo 'alert("Harap maaf Tempahan anda telah gagal dipadamkan")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
                    ...
                    <form action="" method="get">
                        ...
                        if (isset($_GET['kppelanggan'])) {
                            ...
                            if (!empty($kppelanggan)) {
                                $query = mysqli_query($conn, "SELECT * FROM pelanggan INNER JOIN tempahan ON pelanggan.kppelanggan = tempahan.kppelanggan INNER JOIN tayangan ON tayangan.idtayangan = tempahan.idtayangan WHERE tempahan.kppelanggan = '$kppelanggan'");
                            } else {
                                $query = mysqli_query($conn, "SELECT * FROM pelanggan INNER JOIN tempahan ON pelanggan.kppelanggan = tempahan.kppelanggan INNER JOIN tayangan ON tayangan.idtayangan = tempahan.idtayangan WHERE tempahan.kppelanggan = '$kppelanggan'");
                            }
                        } else {
