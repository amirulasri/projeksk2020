...
<body>
    ...
    if (isset($_GET['gagal'])) {
        ...
        echo 'alert("harap maaf Nama pengguna atau kata laluan salah.sila cuba lagi")';
        echo '</script>';
    }
    if (isset($_GET['logkeluar'])) {
        echo '<script language="javascript">';
        echo 'alert("Tahniah anda telah berjaya Log keluar.terima kasih kerana menggunakan sistem kami")';
        echo '</script>';
    }
