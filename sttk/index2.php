...
<?php
    if (isset($_GET['sudahdaftar'])) {
        ...
        echo 'alert("tahniah Anda telah berjaya mendaftar sebagai pelanggan. Anda tidak boleh mendaftar sekali lagi. Teruskan dengan tempahan tiket wayang.Terima Kasih")';
        echo '</script>';
    }
    if (isset($_GET['gagaltempahkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Harap maaf Tempahan anda gagal. Anda telah memasukkan Nombor Kad Pengenalan Yang salah. Sila cuba lagi")';
        echo '</script>';
    }
    ...
    if (isset($_GET['gagaldaftarkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Harap maaf Pendaftaran anda Gagal. KP pelanggan telah pun digunakan. Atau anda memasukkan NO KP yang salah.sila cuba lagi")';
        echo '</script>';
    }
    ?>
    <div class="header">
