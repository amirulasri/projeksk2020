...
<?php
    if (isset($_GET['sudahdaftar'])) {
        ...
        echo 'alert("Tahniah! pendaftaran anda sebagai pelanggan diluluskan. Pendaftaran tidak perlu dilakukan sekali lagi. Teruskan dengan tempahan homestay.")';
        echo '</script>';
    }
    if (isset($_GET['gagaltempahkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan anda gagal. Nombor kad pengenalan yang diisi adalah salah. Isikan semula")';
        echo '</script>';
    }
    if (isset($_GET['berjayatempah'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan anda diluluskan. Untuk mengetahui lebih lanjut, Sila lihat di bahagian carian dan isikan nombor kad pengenalan anda.")';
        echo '</script>';
    }
