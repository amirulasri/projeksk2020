...
<body>
    ...
    if (isset($_GET['gagal'])) {
        ...
        echo 'alert("Nama pengguna atau katalaluan yang diisikan adalah salah")';
        echo '</script>';
    }
    if (isset($_GET['logkeluar'])) {
        echo '<script language="javascript">';
        echo 'alert("log keluar diluluskan")';
        echo '</script>';
    }
    if (isset($_GET['daftarberjaya'])) {
        echo '<script language="javascript">';
        echo 'alert("Pendaftaran anda berjaya. Anda boleh log masuk dengan menggunakan ID dan KATA LALUAN anda")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
