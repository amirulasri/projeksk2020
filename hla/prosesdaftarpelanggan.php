...
if (isset($_SESSION['User'])) {
    if (isset($_POST['submit'])) {
        ...
        if(!empty($kppelanggan)){
            ...
            $query = mysqli_query($conn, "INSERT INTO pelanggan (kppelanggan, umur, namapelanggan, email, notelpelanggan) VALUES ('$kppelanggan', '$umur', '$namapelanggan', '$emailpelanggan', '$nombortelefon')");
            if ($query) {
