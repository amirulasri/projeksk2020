...
<body>
    ...
    if (isset($_GET['tidaktersedia'])) {
        ...
        echo 'alert("Nama pengguna yang anda masukkan tidak tersedia. Sila Gunakan nama pengguna yang lain")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
    ...
    <script>
        function stringlength(inputtxt, minlength, maxlength) {
            ...
            if (field.length < mnlen) {
                ...
                return confirm('Anda telah melengkapkan maklumat dengan betul. Klik OK untuk meneruskan pendaftaran, Klik Cancel jika mahu membatalkan pendaftaran');
            }
        }
    </script>
</body>
