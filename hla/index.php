...
<?php
    if (isset($_GET['sudahdaftar'])) {
        ...
        echo 'alert("Anda sudah  mendaftar sebagai pelanggan. Anda tidak boleh mendaftar sekali lagi. Teruskan dengan menempah homestay.")';
        echo '</script>';
    }
    if (isset($_GET['gagaltempahkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Maaf tempahan anda gagal. Anda telah memasukkan Nombor Kad Pengenalan Yang salah. Sila cuba lagi")';
        echo '</script>';
    }
    ...
    if (isset($_GET['berjayadaftar'])) {
        echo '<script language="javascript">';
        echo 'alert("Tahniah anda telah berjaya mendaftar sebagai pelanggan. Teruskan dengan tempahan.")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
