        ...
        <div class="ui">
            ...
            <div class="interfacelogin">
                <form action="prosesdaftar.php" method="post" name="form1">
                    <div class="mainmenu">
                        <h2 id="tukarwarna">Daftar Pengguna Baru</h2><br>
                        <label for="" class="loginlabel" id="tukarwarna">Username:</label>
                        <input type="text" class="loginarrange" name="id" required><br><br>
                        <p class="alert" id="kurang" style="display: none;">Kata laluan yang anda masukkan kurang dari 8 angka</p>
                        <p class="alert" id="lebih" style="display: none;">Kata laluan yang anda masukkan lebih dari 8 angka</p>
                        <label for="" id="tukarwarna">Password:</label>
                        <input type="text" name="katalaluan" placeholder="Tidak boleh kurang dan melebihi 8 angka" required><br><br>
    ...
    <script>
        function stringlength(inputtxt, minlength, maxlength) {
            ...
            if (field.length < mnlen) {
                ...
                return confirm('Anda telah melengkapkan maklumat dengan tepat. Klik OK untuk meneruskan pendaftaran, Klik Cancel untuk membatalkan pendaftaran');
            }
        }
    </script>
</body>
