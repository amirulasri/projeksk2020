...
<body>
    ...
    if (isset($_GET['perlu'])) {
        ...
        echo 'alert("Anda perlu melengkapkan maklumat diri anda dahulu sebelum membuat tempahan")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
        <div class="ui">
            ...
            <div class="interface">
                <div class="mainmenu">
                    ...
                    <h2 id="tukarwarna">Daftar Pelanggan</h2><br>
                        <label for="" id="tukarwarna">Kad Pengenalan Pelanggan</label>
                        <input type="text" name="kppelanggan" placeholder="Tanpa space dan -" required /><br>
                        <laxbel for="" id="tukarwarna">Nama Pelanggan:</label>
                        ...
                        <label for="" id="tukarwarna">Umur:</label>
