...
<body>
    ...
    if (isset($_GET['logkeluar'])) {
        ...
        echo 'alert("Log keluar telah berjaya,terima kasih kerana membuat tempahan dengan sistem kami")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])){
        echo '<script language="javascript">';
        echo 'alert("Nama pengguna atau kata laluan salah sila cuba lagi")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
