...
<?php
    if (isset($_GET['sudahdaftar'])) {
        ...
        echo 'alert("Anda sudah mendaftar sebagai pelanggan. Anda tidak boleh mendaftar sekali lagi. Teruskan dengan tempahan tiket wayang.")';
        echo '</script>';
    }
    ...
    if (isset($_GET['berjayatempah'])) {
        echo '<script language="javascript">';
        echo 'alert("Tahniah Tempahan berjaya!!!. Untuk melihat tempahan anda, Anda boleh lihat di bahagian carian dan masukkan nombor kad pengenalan anda.")';
        echo '</script>';
    }
    if (isset($_GET['gagaldaftarkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Pendaftaran Gagal. KP pelanggan telah digunakan. Atau anda memasukkan NO KP yang salah.")';
        echo '</script>';
    }
    ?>
    <div class="header">
