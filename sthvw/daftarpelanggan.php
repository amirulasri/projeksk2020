...
<body>
    ...
    if (isset($_GET['perlu'])) {
        ...
        echo 'alert("Maaf sebelum anda membuat tempahan anda perlu melengkapkan maklumat anda terlebih dahulu untuk meneruskan proses tempahan")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
            ...
            <div class="interface">
                <div class="mainmenu">
                    ...
                    <h2>Daftar Pengguna Baru</h2><br>
                        ...
                        <label for="" id="tukarwarna">Pilih jantina:</label>
