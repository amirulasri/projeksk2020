...
<?php
    if (isset($_GET['sudahdaftar'])) {
        ...
        echo 'alert("Anda sudah didaftar sebagai pelanggan. Anda tidak boleh mendaftar sekali lagi. Teruskan dengan tempahan homestay.")';
        echo '</script>';
    }
    if (isset($_GET['gagaltempahkp'])) {
        echo '<script language="javascript">';
        echo 'alert(" Maaf tempahan anda gagal. Nombor Kad Pengenalan yang anda masukkan salah. Sila cuba lagi")';
        echo '</script>';
    }
