...
<body>
    ...
    if (isset($_GET['gagal'])) {
        ...
        echo 'alert("Nama pengguna atau kata laluan yang dimasukkan salah. Sila cuba lagi.")';
        echo '</script>';
    }
    if (isset($_GET['logkeluar'])) {
        echo '<script language="javascript">';
        echo 'alert("Log keluar anda telah berjaya")';
        echo '</script>';
    }
    if (isset($_GET['daftarberjaya'])) {
        echo '<script language="javascript">';
        echo 'alert("Maklumat anda telah berjaya didaftarkan. Sila log masuk menggunakan ID dan KATA LALUAN anda")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
