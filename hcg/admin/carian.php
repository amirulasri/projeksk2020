...
<body>
    ...
    if (isset($_GET['berjaya'])) {
        ...
        echo 'alert("Tempahan anda sudah dipupuskan")';
        echo '</script>';
    }
    if (isset($_GET['berjayakemaskini'])) {
        echo '<script language="javascript">';
        echo 'alert("Anda berjaya mengemaskini")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])) {
        echo '<script language="javascript">';
        echo 'alert("Anda berjaya memadamkan tempahan")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><b><?php echo $carian['namarumah']; ?></b> <br> <?php echo $carian['pemandangan']; ?></td>
