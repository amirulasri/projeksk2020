...
<body>
    <?php
    //Popup berjaya log keluar
    if (isset($_GET['logkeluar'])) {
        echo '<script language="javascript">';
        echo 'alert("You have logged out of the system")';
        echo '</script>';
    }
    //Popup gagal log masuk
    if (isset($_GET['gagal'])){
        echo '<script language="javascript">';
        echo 'alert("The username or the password is incorrect")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
