...
<body>
    ...
    if (isset($_GET['tidaktersedia'])) {
        ...
        echo 'alert("The username you tried has already been used. Please try another one")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
    ...
    <script>
        function stringlength(inputtxt, minlength, maxlength) {
            ...
            if (field.length < mnlen) {
                ...
                return confirm('You have filled out the registeration form correctly. Click OK to register, Click CANCEL to cancel your regsiteration');
            }
        }
    </script>
</body>
