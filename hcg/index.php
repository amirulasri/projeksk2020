...
<?php
    if (isset($_GET['sudahdaftar'])) {
        ...
        echo 'alert("You have already registered. You dont need to register again. Proceed to order your rooms.")';
        echo '</script>';
    }
    if (isset($_GET['gagaltempahkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Transaction failed. You have put in the wrong kad pengenalan number. Pleas try again")';
        echo '</script>';
    }
    if (isset($_GET['berjayatempah'])) {
        echo '<script language="javascript">';
        echo 'alert("Transaction has been succesful!!!. To view your orders, You can search for it in the carian section and input your kad pengenalan.")';
        echo '</script>';
    }
    if (isset($_GET['berjayadaftar'])) {
        echo '<script language="javascript">';
        echo 'alert("You have succesfully register as a customer. Proceed with your transactions.")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
