            ...
            <div class="interface">
                <div class="mainmenu">
                    <form action="" method="get">
                        ...
                        $query = mysqli_query($conn, "SELECT * FROM pelanggan INNER JOIN tempahan ON pelanggan.kppelanggan INNER JOIN rumah ON rumah.idrumah = tempahan.idrumah WHERE tempahan.kppelanggan = '$kppelanggan'");
                        ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $carian['namarumah']; ?></td>
