...
<body>
    ...
    if (isset($_GET['gagal'])) {
        ...
        echo 'alert("Gagal kerana nama pengguna atau kata laluan anda salah")';
        echo '</script>';
    }
    ...
    if (isset($_GET['daftarberjaya'])) {
        echo '<script language="javascript">';
        echo 'alert("Anda sudah berjaya didaftarkan dalam akaun homestay kami. Sila log masuk dengan menggunakan ID dan KATA LALUAN anda")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
