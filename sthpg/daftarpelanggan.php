...
<body>
    ...
    if (isset($_GET['perlu'])) {
        ...
        echo 'alert("Anda hendaklah melengkapkan maklumat diri")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
        <div class="ui">
            ...
            if (isset($_POST['idrumah'])) {
                $idtayangan = $_POST['idrumah'];
            }
            if (isset($_POST['jumlahharga'])) {
                $jumlahtiket = $_POST['jumlahharga'];
            }
            if (isset($_POST['tarikhmasuk'])) {
                $tarikhtayangan = $_POST['tarikhmasuk'];
            }
            $querymovie = mysqli_query($conn, "SELECT * FROM homestay");
            ?>
            <div class="interface">
                <div class="mainmenu">
                    ...
                    <h2>Daftar Pengguna Baru</h2><br>
                        ...
                        <select name="jantina" id="" class="select" required>
                            <option value="jantina">Lelaki</option>
                            <option value="jantina">Perempuan</option>
                        </select><br>
