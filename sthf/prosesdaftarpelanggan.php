...
if (isset($_SESSION['User'])) {
    if (isset($_POST['submit'])) {
        ...
        if(!empty($kppelanggan)){
            ...
            $query = mysqli_query($conn, "INSERT INTO pelanggan (kppelanggan, jantina, namapelanggan, email, notelpelanggan) VALUES ('$kppelanggan', '$jantina', '$namapelanggan', '$emailpelanggan', '$nombortelefon')");
            if ($query) {
