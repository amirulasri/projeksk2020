...
<?php
    if (isset($_GET['sudahdaftar'])) {
        ...
        echo 'alert("Anda telah pun mendaftar sebagai pelanggan. Anda tidak perlu mendaftar sekali lagi. Teruskan dengan tempahan homestay.")';
        echo '</script>';
    }
    if (isset($_GET['gagaltempahkp'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan tidak terlaksana. Anda kemungkinan memasukkan Nombor Kad Pengenalan Yang salah atau sudah didaftarkan. Sila cuba lagi")';
        echo '</script>';
    }
    if (isset($_GET['berjayatempah'])) {
        echo '<script language="javascript">';
        echo 'alert("Tempahan sudah berjaya!!!. Untuk melihat tempahan anda, Anda boleh lihat di bahagian carian dan masukkan nombor kad pengenalan anda.")';
        echo '</script>';
    }
