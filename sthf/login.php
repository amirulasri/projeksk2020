...
<body>
    <?php
    //Pop-up untuk log masuk pelanggan
    if (isset($_GET['gagal'])) {
        echo '<script language="javascript">';
        echo 'alert("Nama pengguna atau kata laluan yang anda masukkan kemungkinan salah")';
        echo '</script>';
    }
    if (isset($_GET['logkeluar'])) {
        echo '<script language="javascript">';
        echo 'alert("Anda telah berjaya log keluar")';
        echo '</script>';
    }
    if (isset($_GET['daftarberjaya'])) {
        echo '<script language="javascript">';
        echo 'alert("Yeay, anda telah berjaya didaftarkan. Sila log masuk dengan menggunakan ID dan KATA LALUAN anda")';
        echo '</script>';
    }
    ?>
    <!-- Antara muka log masuk pelanggan -->
    <div class="uiinner">
        <div class="ui">
            <nav class="navbar">
                <div class="logoinner">
