...
<body>
    ...
    if (isset($_GET['tidaktersedia'])) {
        ...
        echo 'alert("Nama pengguna yang anda masukkan tidak wujud. Gunakan nama pengguna yang lain")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
    ...
    <script>
        function stringlength(inputtxt, minlength, maxlength) {
            ...
            if (field.length < mnlen) {
                ...
                return confirm('Anda telah melengkapkan maklumat dengan selengkapnya. Sila klik OK untuk meneruskan pendaftaran, Klik Cancel untuk membatalkan pendaftaran');
            }
        }
    </script>
</body>
