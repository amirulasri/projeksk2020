...
<body>
    ...
    if (isset($_GET['logkeluar'])) {
        ...
        echo 'alert("Anda berjaya log keluar Terima kasih kerana membuat tempahan dengan kami")';
        echo '</script>';
    }
    if (isset($_GET['gagal'])){
        echo '<script language="javascript">';
        echo 'alert("Maaf nama pengguna atau kata laluan yang anda masukkan adalah salah Sila cuba sekali lagi.")';
        echo '</script>';
    }
    ?>
    <div class="uiinner">
